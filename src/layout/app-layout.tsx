...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'owner', 'employee', 'hr-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Customer', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
    { name: 'Employee', path: '/employees', entity: 'employee', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
